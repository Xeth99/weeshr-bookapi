...
app.use("/users", authorRouter_1.default);
describe("Author Routes", () => {
    ...
    it("should get all authors", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).get("/users/allAuthors");
    ...
    it("should get a specific author by ID", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield (0, supertest_1.default)(app).get(`/users/getAuthorById/${authorId}`);
        expect(response.status).toBe(200);
        // Add more assertions as needed
    }));
    ...
    it("should delete an author", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield (0, supertest_1.default)(app).delete(`/users/deleteAuthor/${authorId}`);
        expect(response.status).toBe(200);
    }));
});
